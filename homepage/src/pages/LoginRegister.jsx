...
function App() {
    ...
    return (
        <main className="relative bg-white overflow-hidden w-[80%] max-w-full min-h-[400px] h-[600px] mx-auto mt-10 mb-10">
            <Components.SignUpComponent signIn={signIn} className="absolute top-0 left-0 h-full w-1/2 opacity-0 transition-all duration-500 ease-in-out">
                <div className="flex bg-white justify-center items-center flex-col h-full text-center px-[50px]">
                    <div className="text-left font-bold mb-2">BYTE</div>
            ...
            <Components.SignInComponent signIn={signIn} className="absolute top-0 left-0 h-full w-1/2 transition-all duration-500 ease-in-out">
                <div className="flex bg-white justify-center items-center flex-col h-full text-center px-[50px]">
                    <div className="text-left font-bold mb-2">BYTE</div>
            ...
            <Components.OverlayProperty signIn={signIn} className="absolute top-0 left-1/2 h-full w-1/2 overflow-hidden transition-all duration-500 ease-in-out">
                <Components.Overlay signIn={signIn} className="relative text-white h-full transition-transform duration-500 ease-in-out bg-cover bg-no-repeat translate-x-0 -left-full w-[200%]">
                    ...
                    <Components.LeftPanel signIn={signIn} className="absolute flex flex-col justify-center items-center text-center top-0 h-full w-1/2 bg-gradient-to-tr from-blue-900 via-blue-500 to-blue-900 translate-x-0 transition-transform duration-500 ease-in-out">
                    ...
                    <Components.RightPanel signIn={signIn} className="absolute flex flex-col justify-center items-center text-center top-0 right-0 h-full w-1/2 bg-gradient-to-tl from-blue-900 via-blue-500 to-blue-900 translate-x-0 transition-transform duration-500 ease-in-out">
                        <div className="text-center text-3xl animate-shake mb-1"><MdWavingHand /></div>
                        <div className="m-0 font-bold text-3xl">Hello, Student!</div>
                        <div className="border-2 w-full border-white inline-block mb-2 mt-2 "></div>
